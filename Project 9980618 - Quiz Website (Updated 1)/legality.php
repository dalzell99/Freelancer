...
<div class="container margin-top" style=" background: url(images/backgrond.png); min-height:390px;">
    ...
    <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12 font">
        ...
        <div class="margin-top">
            ...
            <div class=" margin-top-10">Games can be broadly classified into the following two categories</div>
            <div style="margin-left:30px;">
              <strong>•	Games of chance</strong>, where the winner is determined entirely by mere luck, the result is wholly uncertain and doubtful and a human being cannot apply his/her mind to estimate the result or his/her efforts to influence the result. Generally, such games are illegal as constituting gambling.
                <p class="margin-top-10"><strong>•	Games of skill,</strong> where, skill plays the dominant role and the result depends primarily upon the relative knowledge, training, attention, experience, and/or adroitness of the participants. Generally, such games are not deemed to constitute 'gambling' and do not fall foul of the laws prohibiting gambling.</p>
                <div> For a game to be considered a 'game of skill' under Indian law, the element of skill must predominate the element of chance in affecting the results of the game. Thus, the extent to which skill is involved in the game is the key factor in the determination of the nature and legality of the game under Indian law.
Accordingly, games involving knowledge and IQ from various fields to answer questions in a quiz are game of skill where winning on chance has zero 
probability</div>
        ...
        <div class="margin-top">
            ...
            <div style="margin-left:30px;">
                ...
                <p class="margin-top-10">The most important aspect this quiz contest is to give maximum correct answers in minimum time to declare the winner. Contestants have maximum of 12 seconds to give correct answer as each quiz game consist of 10 question and maximum time allotted is 120 seconds to complete the quiz during the schedule time only. Thus, giving a correct answer for the question asked requires skill, IQ and knowledge from various fields. Giving maximum correct answers in minimum time is a HIGH SKILL game as out of all registered user for a particular quiz one who gives possess the sharpest IQ and intelligencecan only give maximum correct answer in minimum time and win the quiz</p>
