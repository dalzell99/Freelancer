...
function createQuestions() {
    var htmlQuestions = '';
    var htmlFooter = '';
   // htmlFooter += '<div class="row"> <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12" ><div class="col-md-2 col-sm-2 col-lg-2"></div><div class="col-md-8 col-sm-10 col-xs-12 col-lg-8 " style="float:right;"><ul class="pagination" style="margin: -57px 36px 69px 133px;">';

    var questions = JSON.parse(quiz.questions);

    for (var i = 0; i < questions.length; i += 1) {
        htmlQuestions += "<div class='questionContainer " + i + "  text-center'>";
        htmlQuestions += "    <div class='quetion'>" + questions[i][0] + "</div>";
       ...
       // htmlFooter += "<li><span class='btn btn-default pagination questionButton " + i + " col-xs-2 col-sm-1'  style='color:#fff !important'   onclick='goToQuestion(" + i + ")'>" + (i + 1) + "</span></li>";
