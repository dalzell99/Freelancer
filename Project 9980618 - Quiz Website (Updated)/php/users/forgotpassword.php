...
if (mysqli_num_rows($resultUser) > 0) {
    ...
    <html>
        <body>
            ...
            <p><a href='https://iqzeto.com/forgot-password.php?username=" . $username . "&password=" . $password . "'>https://iqzeto.com/forgot-password.php?username=" . $username . "&password=" . $password . "</a></p>
