    ...
    <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12 font">
        ...
        <div class="margin-top">
            ...
            <div style="margin-left:30px;">
                <p class="margin-top-10">•	Before or at the time of collecting personal information, we will identify the purposes for which information is being collected.
                </p>
                <p class="margin-top-10">•	We will collect and use of personal information solely with the objective of fulfilling those purposes specified by us and for other compatible purposes, unless we obtain the consent of the individual concerned or as required by law.</p>
                <p class="margin-top-10">•	We will only retain personal information as long as necessary for the fulfillment of those purposes.</p>
        ...
        <div class="margin-top">
            ...
            <div style="margin-left:30px;">
               "Non Personal Information" is information that is not personally identifiable to you and that we automatically collect when you access our Website with a web browser. It may also include publicly available information that is shared between you and others.
                <p class="margin-top-10">"Personally Identifiable Information" is non-public information that is personally identifiable to you and obtained in order for us to provide you within our Website. Personally Identifiable Information may include information such as your name, email address, and other related information that you provide to us or that we obtain about you.</p>

            </div>
        </div>

        <div class="margin-top">
            <h3 class="red"><strong>Information We Collect</strong></h3>
            <div style="margin-left:30px;">
               Generally, you control the amount and type of information you provide to us when using our Website.
                <p class="margin-top-10">As a Visitor, you can browse our website to find out more about our Website. You are not required to provide us with any Personally Identifiable Information as a Visitor.</p>
            </div>
        </div>

        <div class="margin-top">
            <h3 class="red"><strong>Computer Information Collected</strong></h3>
            <div style="margin-left:30px;">
             When you use our Website, we automatically collect certain computer information by the interaction of your mobile phone or web browser with our Website. Such information is typically considered Non Personal Information.
                <div style="margin-left:50px;">
                    <strong> We also collect the following: </strong>
                    <h3 style="font-size: 19px;"><strong>•	Cookies</strong></h3>
                    ...
                    <h3 style="font-size: 19px;"><strong>•	Geographical Information</strong></h3>
                    <p class="margin-top-10">When you use the mobile application, we may use GPS technology (or other similar technology) to determine your current location in order to determine the city you are located within and display information with relevant data or advertisements. We will not share your current location with other users or partners. If you do not want us to use your location for the purposes set forth above, you should turn off the location services for the mobile application located in your account settings or in your mobile phone settings and/or within the mobile application.</p>
                    <h3 style="font-size: 19px;"><strong>•	Automatic Information</strong></h3>
                    <p class="margin-top-10">We automatically receive information from your web browser or mobile device. This information includes the name of the website from which you entered our Website, if any, as well as the name of the website to which you're headed when you leave our website. This information also includes the IP address of your computer/proxy server that you use to access the Internet, your Internet Website provider name, web browser type, type of mobile device, and computer operating system. We use all of this information to analyze trends among our Users to help improve our Website.  </p>
                    <h3 style="font-size: 19px;"><strong>•	Log Data</strong></h3>
                    <p class="margin-top-10">Like many Website operators, we collect information that your browser sends whenever you visit our Website ("Log Data"). This Log Data may include information such as your computer's Internet Protocol ("IP") address, browser type, browser version, the pages of our Website that you visit, the time and date of your visit, the time spent on those pages and other statistics. </p>

                </div>
                Under the Child's Online Privacy Security Act, no Website operator can require, as a condition to involvement in an activity, that a child younger than 13 years of age divulge more details than is reasonably required. Quizeto Pvt Ltd abides by this demand. Quizeto Pvt Ltd just collects information willingly offered; no information is gathered passively. children under 13 can submit only their email address when sending us an email in our "Contact Us" area. Quizeto Pvt Ltd makes use of the e-mail address to respond to a one-time demand from a child under 13 and afterwards deletes the e-mail address. In case Quizeto Pvt Ltd collects and maintains personal information relating to a child under 13, the parent may send out an email to us to review, alter and/or erase such info as well as to decline to enable any additional collection or use of the child's information.

            </div>
        </div>

        <div class="margin-top">
            <h3 class="red"><strong>How We Use Your Information</strong></h3>
            <div style="margin-left:30px;">

                <div style="margin-left:50px;">
                    <strong>We use the information we receive from you as follows:</strong>
                    <h3 style="font-size: 19px;"><strong>•	Customizing Our Website</strong></h3>
                    <p class="margin-top-10">We may use the Personally Identifiable information you provide to us along with any computer information we receive to customize our Website.</p>
                    <h3 style="font-size: 19px;"><strong>•	Sharing Information with Affiliates and Other Third Parties</strong></h3>
                    <p class="margin-top-10">We do not sell, rent, or otherwise provide your Personally Identifiable Information to third parties for marketing purposes. We may provide your Personally Identifiable Information to affiliates that provide services to us with regards to our Website (i.e. payment processors, Website hosting companies, etc.); such affiliates will only receive information necessary to provide the respective services and will be bound by confidentiality agreements limiting the use of such information.</p>
                    <h3 style="font-size: 19px;"><strong>•	Data Aggregation</strong></h3>
                    ...
                    <div style="margin-left:70px">(a) required by subpoena, law, or other legal process; 
                        ...
                        <p class="margin-top-10">(e) necessary to protect the legal rights, personal/real property, or personal safety of Quizeto Pvt Ltd, our Users, employees, and affiliates.</p>
        ...
        <div class="margin-top">
            <h3 class="red"><strong>Opt-Out</strong></h3>
            <div style="margin-left:30px;">
        ...
        <div class="margin-top">
            <h3 class="red"><strong>Security</strong></h3>
            <div style="margin-left:30px;">
        ...
        <div class="margin-top">
            <h3 class="red"><strong>Privacy Policy Updates</strong></h3>
            <div style="margin-left:30px;">
        ...
        <div class="margin-top" style=" margin-bottom:30px;">
            <h3 class="red"><strong>Questions About Our Privacy Practices or This Privacy Policy</strong></h3>
            <div style="margin-left:30px;">
